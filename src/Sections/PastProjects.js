...
const PastProjects = () => {
	const [pastProjects, setPastProjects] = useState([
		...
		{ category: "se", title: "This Personal Website!", text: "A full stack personal website involving HTML, CSS, React, and a NodeJS backend. Featuring personally created artwork, music from Spotify, and a contact section which sends your message to my Telegram bot.", img: require("../assets/image/portfolio-website.png"), link: "https://github.com/sirDevelop/portfolio-website", linkTitle: "Source Code" },
					...
					{pastProjects.sort((a, b) => {
						...
						return (
							<Col sm={4} key={i} className={`pb-3 projects ${activeFilter !== project.category && activeFilter !== "*" ? "hidden-project" : ""}`} >
								<Card>
									<Card.Img variant="top" className="card-img-top" width="250px" height="250px" src={project.img} />
									<Card.Body>
